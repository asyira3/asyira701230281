...
$koneksi = mysqli_connect("localhost", "root", "") or die("") or die("koneksi ke database gagal");
mysqli_select_db ($koneksi, "tb_anggota") or die ("database tidak ada");
...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Minat:</label>
                <input type="checkbox" name="minat[]" value="Manejer"> Manejer
                <input type="checkbox" name="minat[]" value="Sketaris"> Sketaris
                <input type="checkbox" name="minat[]" value="Admitrasi"> Admitrasi
                <input type="checkbox" name="minat[]" value="Obe"> Obe
            </div>
